...
from common.laserscan_ros import LaserScan, SemLaserScan
import torchvision
...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
    ...
    print("Using scans from topic /ouster/points")
  ...
  def set_points(self, data):
    ...
    self.scan.get_scan(data)
    
    return self.__getitem__()
  
  def get_points(self):
     return self.scan.points
...
class Parser():
  ...
  def get_test_set(self, data):
    return self.test_dataset.set_points(data)
  ...
  def get_points(self):
     return self.test_dataset.get_points()
  
  def get_scan(self):
     return self.test_dataset.get_scan()